 ...
 * - Worker 通过 {@link BlockingQueue} 池化分配，确保同一 Worker 不会被两个步骤并发占用
...
public class AgentOrchestrator {
     ...
     */
    public void setSkillSystem(com.mycliagent.skill.SkillRegistry skillRegistry,
                               com.mycliagent.skill.SkillContextBuffer skillContextBuffer) {
